...
echo "DOCKER_BUILD_ENV=${DOCKER_BUILD_ENV}"

source ./scripts/updateURLs.sh ${DOCKER_BUILD_ENV}
...
#set -x
bx cr build --no-cache -t ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/${IMAGE_NAME}:${IMAGE_TAG} ${DOCKER_ROOT} -f ${DOCKER_FILE}
#set +x
